...
/datum/computer_file/program/ntnetdownload/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = TRUE, datum/tgui/master_ui = null, datum/ui_state/state = GLOB.default_state)
