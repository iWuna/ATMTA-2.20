...
/datum/turntable_soundtrack/fallout1
	f_name = "T"
	name = "ake me home"
	path = 'sound/turntable/takemehome.ogg'

/datum/turntable_soundtrack/fallout2
	f_name = "J"
	name = "ingle Jangle Jingle"
	path = 'sound/turntable/Jingle Jangle Jingle.ogg'

/datum/turntable_soundtrack/fallout3
	f_name = "J"
	name = "ohnny Guitar"
	path = 'sound/turntable/Johnny Guitar.ogg'

/datum/turntable_soundtrack/fallout4
	f_name = "G"
	name = "oin Under"
	path = 'sound/turntable/Goin Under.ogg'

/datum/turntable_soundtrack/fallout5
	f_name = "B"
	name = "ig Iron"
	path = 'sound/turntable/Big Iron.ogg'