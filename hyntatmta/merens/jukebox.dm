...
/obj/machinery/party/turntable/attack_hand(mob/living/user as mob)
	...
	var/t = "<br><br><div align='center'><table border='0'><B><font size='5' color='purple'>Juke Box</font>Interface</font></B><br><br><br><br>"
	t += "<A href='?src=\ref[src];on=1'>On</A><br>"
	if(disk)
		t += "<A href='?src=\ref[src];eject=1'>Eject disk</A><br>"
	t += "<tr><td height='50' weight='50'></td><td height='50' weight='50'><A href='?src=\ref[src];off=1'><font color='maroon'>T</font>urn <font color='red'>Off</font></A></td><td height='50' weight='50'></td></tr>"
	t += "<tr>"
	...
	for(var/datum/turntable_soundtrack/D in turntable_soundtracks)
		t += "<td height='50' weight='50'><A href='?src=\ref[src];on=\ref[D]'><font color='maroon'>[D.f_name]</font>[D.name]</font></A></td>"
		i++
		if(i == 1)
	...
	if(disk)
		if(disk.data)
			...
			t += "<td height='50' weight='50'><font color='maroon'>D</font>isk empty</font></td>"
